...
class State(): 
    def __init__(self, x, y, stateType):
        ...
        self.xy = (x, y)
        # action rewards in order 0 up, 1 down, 2 right, 3 left
...
def main():
    ...
    # Run 100 episodes
    while (qAgent.episode < 100 and sAgent.episode < 100):
        sAgent.sarsaIteration()
        print("Episode: " + str(sAgent.episode) + ", Reward: " + str(sAgent.reward) )
